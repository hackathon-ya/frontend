...
const NewVacancy = () => {
  ...
  return (
    <section className={styles.NewVacancy}>
      <button className={styles.NewVacancy__button_vacancy}>
        <Link to="" className={styles.NewVacancy__link}>
          Назад
        </Link>
      </button>
      <form
        className={styles.NewVacancy__form}
      ...
      >
        ...
        <div className={styles.NewVacancy__input_moneys}>
          <div className={styles.NewVacancy__input_money}></div>
          <div className={styles.NewVacancy__input_money}></div>
        </div>
        ...
        <div className={styles.NewVacancy__buttons}>
          <button className={styles.NewVacancy__button_published}>
            Сохранить и опубликовать
          </button>
          <button className={styles.NewVacancy__button_save}>
            Сохранить черновик
          </button>
        </div>
      </form>
